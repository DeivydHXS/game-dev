...
void Game::initWindow() {
  ...
  this->window = new sf::RenderWindow(this->videoMode, "Simple Game");
...
void Game::spawnEnemy() {
  /**
    ...
    Spawns enemies and sets their types, colors and positions randoly.
  ...
  */
  ...
  this->enemy.setPosition(
    ...
    static_cast<float>(rand() % static_cast<int>((this->window->getSize().y / 2) - this->enemy.getSize().y))
  );
